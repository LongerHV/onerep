...
func HistoryDetailPage(p Page, d HistoryDetail) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 63, "<input type=\"hidden\" name=\"group_pos\" value=\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		var templ_7745c5c3_Var50 string
		templ_7745c5c3_Var50, templ_7745c5c3_Err = templ.ResolveAttributeValue(strconv.Itoa(d.NextGroupPos))
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/views/history.templ`, Line: 98, Col: 76}
		}
		...
		var templ_7745c5c3_Var51 = []any{label}
		...
		for _, e := range d.Catalog {
			...
			templ_7745c5c3_Var55, templ_7745c5c3_Err = templ.ResolveAttributeValue(e.Slug)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/views/history.templ`, Line: 103, Col: 27}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/views/history.templ`, Line: 103, Col: 38}
			}
		...
		var templ_7745c5c3_Var57 = []any{btn}
		...
		var templ_7745c5c3_Var59 = []any{h2}
		...
		templ_7745c5c3_Var61, templ_7745c5c3_Err = templ.JoinURLErrs(templ.URL("/history/" + d.Session.ID + "/notes"))
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/views/history.templ`, Line: 111, Col: 78}
		}
		...
		var templ_7745c5c3_Var62 = []any{input}
		...
		templ_7745c5c3_Var64, templ_7745c5c3_Err = templ.JoinStringErrs(d.Session.Notes)
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/views/history.templ`, Line: 113, Col: 86}
		}
		...
		var templ_7745c5c3_Var65 = []any{btnSecondary + " mt-2"}
...
func setFields(p Page, measurement string, set store.Set) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if measurement == "all" || measurement == "weight_reps" || measurement == "bw_reps" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/views/history.templ`, Line: 122, Col: 33}
			}
			...
			var templ_7745c5c3_Var69 = []any{input + " w-24"}
			...
			templ_7745c5c3_Var70, templ_7745c5c3_Err = templ.ResolveAttributeValue(optWeight(set.WeightKg, p.Identity.User.Unit))
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/views/history.templ`, Line: 123, Col: 97}
			}
		...
		if measurement == "all" || measurement == "weight_reps" || measurement == "bw_reps" || measurement == "reps" {
			...
			var templ_7745c5c3_Var72 = []any{input + " w-20"}
			...
			templ_7745c5c3_Var73, templ_7745c5c3_Err = templ.ResolveAttributeValue(optInt(set.Reps))
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/views/history.templ`, Line: 129, Col: 66}
			}
			...
			var templ_7745c5c3_Var75 = []any{input + " w-20"}
			...
			templ_7745c5c3_Var76, templ_7745c5c3_Err = templ.ResolveAttributeValue(optFloat(set.RPE))
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/views/history.templ`, Line: 133, Col: 66}
			}
		...
		if measurement == "all" || measurement == "time" || measurement == "distance_time" {
			...
			var templ_7745c5c3_Var78 = []any{input + " w-24"}
			...
			templ_7745c5c3_Var79, templ_7745c5c3_Err = templ.ResolveAttributeValue(optInt(set.DurationS))
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/views/history.templ`, Line: 139, Col: 75}
			}
		...
		if measurement == "all" || measurement == "distance_time" {
			...
			var templ_7745c5c3_Var81 = []any{input + " w-24"}
			...
			templ_7745c5c3_Var82, templ_7745c5c3_Err = templ.ResolveAttributeValue(optFloat(set.DistanceM))
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/views/history.templ`, Line: 145, Col: 77}
			}
